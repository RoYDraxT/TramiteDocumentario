<html lang="en" class="no-focus">
    <head>
        ...
        <title>Recuperar Contraseña | Trámite Documentario</title>
                                ...
                                <form class="js-validation-signup" action="be_pages_auth_all.html" method="post">
                                    <div class="block block-themed block-rounded block-shadow">
                                        <div class="block-header bg-gd-emerald">
                                            <h3 class="block-title">Ingresar Detalles</h3>
                                        ...
                                        <div class="block-content">
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="email" class="form-control" id="usu_correo" name="usu_correo"le.com">
                                                </div>
                                            </div>
                                            <div class="form-group row justify-content-center mb-0">
                                                <div class="col-sm-6 text-center">
                                                    <button type="button" class="btn btn-alt-success" id="btnrecuperar">
